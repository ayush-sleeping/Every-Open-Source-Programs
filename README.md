...
|  48.       | Google Code-in (GCI)                       |   |   |          | before Oct        |   | Prizes for winners  |
...
|  61.       | (CNCF)  Community Bridge Mentorship Program               | Yes  |   | Summer - (CNCF) participates in LFX Mentorship (ex-CommunityBridge), GSOC , GSOD , CROSS Research Experience Program  |  |   |   |
|  62.       | Redox Summer of code                       | Yes  |   | In Summer |  |   |   |
|  63.       | Radare Summer of Code                      | Yes  |   | RSoC Project take part in GSOC |  |   |   |
|  64.       | Summer of Haskell                          | Yes  |   | SOH projects take part in GSOC |  |   |   |
|  65.       | The X.Org Endless Vacation of Code (EVoC)               | Yes  |   | EVoC mentorship can be initiated at any time during the calendar year |  |   |   |
|  66.       | RARE Technologies Student Incubator Programme               | Yes  |   | Poject take part in GSOC & It took place in Summer |  |   |   |
|  67.       | Vectorised IO                              | Yes  |   | Not found |  |   |   |
|  68.       | Snowplow                                   | Yes  |   | Not found |  |   |   |
|  69.       | RubyMe Mentorship Program                  | Yes  |   | Not found |  |   |   |
|  70.       | Free Software Foundation (FSF) Intership Program               |   |   | winter: December 8 summer: May 10 Fall: September 2. spring: November 29 |  |   |   |
|  71.       | Kubernetes Shadows Program                 |   |   | Shadows are selected via the Release Team Shadow Application, which usually opens up around the end of a release/beginning of the next release |  |   |   |
|  72.       | Millennium Fellowship                      |   |   | Applications for this is open for whole year except Aug to Nov |  |   |   |
|  73.       | Microsoft Learn Student Ambassador Program               |   |   | Application form is open throughout the year |  |   |   |
|  74.       | OpenCode IIITA                             |   |   | starting in October for student |  |   | Certificates & swag rewards  |
|  75.       | OSS World Challenge                        |   |   | The challenge opens every May then close by September |  |   | Prizes for winners  |
|  76.       | 24 Pull Requests                           |   |   | Send 24 pull requests between December 1st and December 24th |  |   |   |
|  77.       | Tweag I/O Summer Internship                |   |   | Not found |  |   |   |
|  78.       | Segment Open Fellowship                    |   |   | Not found |  |   |   |
|  79.       | SOCIS                                      |   |   | Not found |  |   |   |
|  80.       | Sanscript Autumn of Open Source            |   |   | Not found |  | Certificates & swag rewards  |   |
|  81.       | RGSOC                                      |   |   | Not found |  |   |   |
|  82.       | Quantopian Open                            |   |   | Not found |  |   | Cash prizes for winners   |
|  83.       | OWASP SOC                                  |   |   | Not found |  |   |   |
|  84.       | Open Innovation Project                    |   |   | Not found |  |   |   |
|  85.       | Open Source Track Explorer                 |   |   | Not found |  |   |   |
|  86.       | MDG Winter of Code                         |   |   | Not found |  |   |   |
|  87.       | ICFOSS Fellowship Programme                |   |   | Not found |  |   |   |
|  88.       | Halite AI Bot Challenge                    |   |   | Not found |  |   | Swag rewards for winners  |
|  89.       | HackinCodes Contributor's Hack             |   |   | Not found |  |   | Prizes, swag rewards, Certificate  |
|  90.       | Free Software Observation                  |   |   | Not found |  |   |   |
|  91.       | Educational Externship Track               |   |   | Not found |  |   |   |
|  92.       | (DAWOC) DA-IICT Winter of Code             |   |   | Not found |  |   |   |
|  93.       | Data Driven Competitions                   |   |   | Not found |  |   | Cash Prizes For Winners  |
|  94.       | Data Observation National of Earth         |   |   | Not found |  |   |   |
|  95.       | Cats winter of code                        |   |   | Not found |  |   |   |
